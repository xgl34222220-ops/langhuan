...
class QingmoReplicaReaderContractTest {
    @Test
    fun readerKeepsQingmoPanelGridThemeAndMotionContract() {
        val root = File(System.getProperty("user.dir") ?: ".")
        val entry = File(root, "src/main/java/com/xiguli/langhuan/ui/reader/ReaderNativeExperienceV4.kt").readText()
        val reader = File(root, "src/main/java/com/xiguli/langhuan/ui/reader/ReaderQingmoReplicaV8.kt").readText()
        ...
        assertTrue(entry.contains("ReaderQingmoReplicaV8("))
        assertTrue(reader.contains("QingmoReaderTabV8.DETAILS"))
        assertTrue(reader.contains("QingmoReaderTabV8.DIRECTORY"))
        assertTrue(reader.contains("QingmoReaderTabV8.MORE"))
        assertTrue(reader.contains("QingmoThemeGalleryV8("))
        assertTrue(reader.contains("QingmoFontPageV8("))
        assertTrue(reader.contains("QingmoSearchV8("))
