...
class FullShellV4RouteTest {
    ...
    fun rootUsesMobileShelfReaderAndFreshReloadGate() {
        ...
        val novelCharacters = File(root, "src/main/java/com/xiguli/langhuan/ui/TavernNovelCharacterExperienceV3.kt").readText()
        ...
        assertTrue(storyEntry.contains("TavernNovelCharacterExperienceV3("))
        assertFalse(storyEntry.contains("StoryPlayPanelV17("))
        assertTrue(novelCharacters.contains("快速蒸馏"))
        assertTrue(novelCharacters.contains("深度蒸馏"))
        assertTrue(novelCharacters.contains("原文证据"))
        assertTrue(novelCharacters.contains("TavernCharacterHubV2("))
        assertTrue(novelCharacters.contains("StoryCoreExperience("))
